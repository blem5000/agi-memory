class AgentMemory < Formula
  ...
  url "https://github.com/kdbhalala/agi-memory/archive/refs/tags/v0.8.2.tar.gz"
  sha256 "1fa9a0a4921aecfea5ab91140f0c760c0b6edc7a68b4455975dc1193dc627b56"
  license "MIT"
  ...
  test do
    assert_match "agent-memory 0.8.2", shell_output("#{bin}/agent-memory --version")
